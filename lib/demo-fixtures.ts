  ...
  'E-DEMO-001': [
    {
      ...
      duration: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.primary.duration,
      distanceMeters: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.primary.distance,
      durationSeconds: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.primary.duration,
      provider: 'GOOGLE',
      routeType: 'PLANNED',
      status: 'ACTIVE',
      geometry: {
    ...
    },
    {
      ...
      duration: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.alternative?.duration || 720,
      distanceMeters: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.alternative?.distance || 8200,
      durationSeconds: CANONICAL_ROAD_CORRIDORS.MG_ROAD_TO_MANIPAL.alternative?.duration || 720,
      provider: 'GOOGLE',
